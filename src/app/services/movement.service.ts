...
export class MovementService {
    ...
    loadMovements() : Observable<any> {
        return of({}).pipe(tap(() => {
            ...
            this.movements[index].standardText = 'התנועה מתחיל כאשר האתלט שוכב על ספסל ומחזיק במוט מעליו עם ידיים ישרות\n\nעל האתלט לגעת עם המוט בחזהו ולאחר מכן לדחוף אותו כלפי מעלה\n\nהחזרה תספר כאשר האתלט שוכב על הספסל וידיו ישרות לגמרי ואחזות במוט מעליו\n\nחובה על האתלט להציב שומר שיעזור לו במידה ולא יצליח להרים את המוט\n\nעל האתלט להוציא את המוט ולהחזירו בעצמו  אל העמודים עליו המוט מונח בזמן ביצוע שאר התרגילים'
            index++;
